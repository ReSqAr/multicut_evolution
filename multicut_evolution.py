...
prog_helponprg = \
"""
Benötigte Programme und deren Konfiguration
...
""".format(BOLD=C_BOLD,CLEAR=C_CLEAR)
...
class CutFile:
	...
	def GetAspect(self):
		if ".mpg.HQ" in self.path:
			filetype = 'hq'
		elif ".mpg.HD" in self.path:
			fileype = 'hd'
		else:
			filetype = 'unknown'
...
class VDProjectClass:
	...
	def __init__(self, cutfile, cutlist, cutoptions):
		...
		self.SetAspectRatio(self.cutfile.GetAspect(),self.cutfile)
	...
	def SetAspectRatio(self, ratio, cutfile):
		...
		if ratio[0] == "16:9":
			if ratio[1] == 'hq':
				Debug(3, '16:9 HQ')
				Debug(5,'Blob: VirtualDub.video.SetCompData(2994,"ADLICwAAAADRC1lWMTK6C5CyCAAnDf////8ZDRA...')
				...
				Debug(3, '16:9 HD')
				Debug(5,'Blob: VirtualDub.video.SetCompData(2974,"ADLICwAAAADRC1lWMTK6C5CyCAAnD...')
			...
			if ratio[1] == 'hq' :
				Debug(3, '4:3 HQ')
				Debug(5,'Blob: VirtualDub.video.SetCompData(2992,"ADLICwAAAADRC1lWMTK6C5CyCAAnDf...')
				...
				Debug(3,'4:3 HD')
				Debug(5,'Blob: VirtualDub.video.SetCompData(2974,"ADLICwAAAADRC1lWMTK6C5CyCAAnDf////8Z...')
				self.Append('VirtualDub.video.SetCompData(2974,"");')
